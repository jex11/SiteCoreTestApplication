...
using SiteCoreTestApplication.Models.ViewModels;
using System.Web.Security;
using SiteCoreTestApplication.CustomProvider;
...
namespace SiteCoreTestApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(RegisterViewModel model)
        {
            ...
            {
                bool isSuccess = false;
                var user = new CustomMembershipProvider().CreateNewUser(model.UserName, model.Email, model.Password, out isSuccess);
                if (isSuccess && user != null)
                {
